...
class LayeredFNO1d(nn.Module):
    def __init__(self, modes1, width, output_dim, nlayers):
        super(LayeredFNO1d, self).__init__()
...
class LayeredFNO2d(nn.Module):
    def __init__(self, modes1, modes2,  width,  output_dim, nlayers):
        super(LayeredFNO2d, self).__init__()
